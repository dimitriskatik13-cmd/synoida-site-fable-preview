...
ASSETS = os.path.join(ROOT, 'assets'); WIDTHS = (800, 1600, 1920); SKIP = ('logo', 'favicon', 'apple-touch', 'vp-')   # 1920 μόνο για πηγές που το φτάνουν (hero); SKIP = ('logo', 'favicon', 'apple-touch', 'vp-')
made = skipped = 0
for name in sorted(os.listdir(ASSETS)):
    base, ext = os.path.splitext(name)
    if ext.lower() not in ('.jpg', '.jpeg', '.png') or base.startswith(SKIP) or base.endswith(('-800', '-1600', '-1920')): continue
    ...
    with Image.open(src) as im:
        ...
        for w in WIDTHS:
            ...
            if w == 1920 and im.width < 1900: continue
            ...
            im2.save(out, 'WEBP', quality=88 if w == 1920 else 80, method=6); made += 1
